...
func getSkinConfig(db *sql.DB) SkinConfig {
	...
	return SkinConfig{
		...
		HeaderBg:            sanitizeSkinColor(getOption(db, "headerBg", "#f3f4f6cc"), "#f3f4f6cc"),
		ThemeBtnHoverBg:     sanitizeSkinColor(getOption(db, "themeBtnHoverBg", "#1f29370f"), "#1f29370f"),
		ThemeBtnActiveBg:    sanitizeSkinColor(getOption(db, "themeBtnActiveBg", "#3b82f624"), "#3b82f624"),
